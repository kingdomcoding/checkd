...
config :checkd, CheckdWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: CheckdWeb.ErrorHTML, json: CheckdWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Checkd.PubSub,
  live_view: [signing_salt: "Df9+I8ow"]
...
config :checkd, Checkd.Mailer, adapter: Swoosh.Adapters.Local
